...
// HJCache
#define COCOAPODS_POD_AVAILABLE_HJCache
#define COCOAPODS_VERSION_MAJOR_HJCache 0
#define COCOAPODS_VERSION_MINOR_HJCache 0
#define COCOAPODS_VERSION_PATCH_HJCache 1
